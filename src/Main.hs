...
main :: IO()
main = do
        putStrLn "Это консольная шпаргалка по типам и классам в языке Haskell. Меня зовут Роксанна, я буду Вашим помощником. Введите класс или тип и я расскажу о нем" 
        line <- getLine
        if      | line == "Int"      -> putStrLn "Int - число класса Num, имеющее       ограниченную                 длину. Входит в typeclass Integral"
                ...
                | otherwise      -> putStrLn "Ты не ввел данные. Пожалуйста, повтори ввод"
